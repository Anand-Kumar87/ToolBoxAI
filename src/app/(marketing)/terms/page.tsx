...
export const metadata: Metadata = { 
  title: "Terms & Conditions | Korevante Studio",
  description: "Read the terms of service governing access to and usage of Korevante Studio platform and tools.",
};
...
const TERMS_SECTIONS = [
  {
    ...
    content: (
      <>
        <p className="mb-3">
          By registering for an account, accessing, browsing, or utilizing any portion of the Korevante Studio platform, application programming interfaces (APIs), or associated digital utilities (collectively, the &quot;Service&quot;), you enter into a legally binding agreement with Korevante Studio (&quot;we&quot;, &quot;us&quot;, or &quot;our&quot;).
        </p>
        <p className="mb-3">
    ...
    content: (
      <>
        ...
        <ul className="list-disc pl-5 space-y-2 mb-3">
          ...
          <li>Immediately notifying our security team at security@korevante.com if you suspect any unauthorized access or breach of security.</li>
        </ul>
        <p>
  ...
  },
  {
    ...
    content: (
      <>
        <p className="mb-3">
          Korevante Studio provides high-performance computing and generative tools intended for lawful creative, technical, and commercial endeavors. You agree NOT to use the platform to:
        </p>
        <ul className="list-disc pl-5 space-y-2 mb-3">
  ...
  },
  {
    ...
    content: (
      <>
        <p className="mb-3">
          <strong>Your Content:</strong> You retain complete, unrestricted ownership of all inputs, source documents, raw images, videos, and texts you upload, as well as the resulting rendered outputs generated by our tools. You grant Korevante Studio a worldwide, non-exclusive, royalty-free license solely to host, store, and process your content to the extent necessary to deliver the requested service.
        </p>
        <p>
          <strong>Our Platform:</strong> All platform interfaces, graphic designs, logos, software architectures, algorithms, and documentation are the exclusive property of Korevante Studio and protected by applicable copyright and trademark laws.
        </p>
      </>
    ),
  },
  ...
  },
  {
    ...
    content: (
      <>
        <p className="mb-3">
          To the maximum extent permitted by applicable law, in no event shall Korevante Studio, its officers, directors, employees, or affiliates be liable for any indirect, incidental, punitive, special, or consequential damages (including loss of profits, data corruption, or business interruption) arising out of or related to your use of the Service.
        </p>
        <p>
          Our aggregate cumulative liability for any and all claims arising under these Terms shall not exceed the total subscription fees actually paid by you to Korevante Studio during the three (3) calendar months preceding the claim event.
        </p>
      </>
    ),
  },
    ...
    content: (
      <>
        ...
        <div className="neu-pressed p-4 rounded-2xl space-y-1 text-sm mt-4">
          <p><strong>Legal Inquiries:</strong> <a href="mailto:legal@korevante.com" className="text-primary hover:underline">legal@korevante.com</a></p>
          <p><strong>Official Correspondence:</strong> Korevante Studio Technologies, Legal &amp; Compliance Cell, India</p>
        </div>
      </>
    ),
  },
      ...
      <section className="pt-24 pb-14 md:pt-32 md:pb-16 text-center border-b border-border/20">
        <div className="container mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-muted-foreground text-base max-w-2xl mx-auto font-medium">
            Please review these terms carefully. They outline your rights, responsibilities, and licensing agreements when using Korevante Studio.
          </p>
